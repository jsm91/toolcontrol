...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ToolModel.total_price'
        db.delete_column(u'tools_toolmodel', 'total_price')

        # Deleting field 'ToolModel.number_of_tools'
        db.delete_column(u'tools_toolmodel', 'number_of_tools')


    def backwards(self, orm):
        # Adding field 'ToolModel.total_price'
        db.add_column(u'tools_toolmodel', 'total_price',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'ToolModel.number_of_tools'
        db.add_column(u'tools_toolmodel', 'number_of_tools',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)
