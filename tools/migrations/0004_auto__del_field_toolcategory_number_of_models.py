...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ToolCategory.number_of_models'
        db.delete_column(u'tools_toolcategory', 'number_of_models')


    def backwards(self, orm):
        # Adding field 'ToolCategory.number_of_models'
        db.add_column(u'tools_toolcategory', 'number_of_models',
