...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Tool.end_date'
        db.alter_column(u'tools_tool', 'end_date', self.gf('django.db.models.fields.DateField')(null=True))

        # Changing field 'Tool.buy_date'
        db.alter_column(u'tools_tool', 'buy_date', self.gf('django.db.models.fields.DateField')())

    def backwards(self, orm):

        # Changing field 'Tool.end_date'
        db.alter_column(u'tools_tool', 'end_date', self.gf('django.db.models.fields.DateTimeField')(null=True))

        # Changing field 'Tool.buy_date'
        db.alter_column(u'tools_tool', 'buy_date', self.gf('django.db.models.fields.DateTimeField')())
