...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Container.location'
        db.alter_column(u'tools_container', 'location_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['tools.ConstructionSite'], null=True))

    def backwards(self, orm):

        # Changing field 'Container.location'
        db.alter_column(u'tools_container', 'location_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['tools.ConstructionSite']))
    ...
    models = {
        ...
        u'tools.tool': {
            ...
            'buy_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 2, 9, 0, 0)'}),
