...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ToolCategory.total_price'
        db.delete_column(u'tools_toolcategory', 'total_price')


    def backwards(self, orm):
        # Adding field 'ToolCategory.total_price'
        db.add_column(u'tools_toolcategory', 'total_price',
