...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Tool.container'
        db.add_column(u'tools_tool', 'container',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['tools.Container'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Tool.container'
        db.delete_column(u'tools_tool', 'container_id')
