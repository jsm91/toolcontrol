...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TicketAnswer.is_read'
        db.add_column(u'tools_ticketanswer', 'is_read',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TicketAnswer.is_read'
        db.delete_column(u'tools_ticketanswer', 'is_read')
    ...
    models = {
        ...
        u'tools.tool': {
            ...
            'buy_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 3, 4, 0, 0)'}),
