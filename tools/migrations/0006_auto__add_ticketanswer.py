...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'TicketAnswer'
        db.create_table(u'tools_ticketanswer', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('ticket', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['tools.Ticket'])),
            ('text', self.gf('django.db.models.fields.TextField')()),
            ('created_by', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['tools.Employee'])),
            ('timestamp', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal(u'tools', ['TicketAnswer'])


    def backwards(self, orm):
        # Deleting model 'TicketAnswer'
        db.delete_table(u'tools_ticketanswer')
    ...
    models = {
        ...
        u'tools.tool': {
            ...
            'buy_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 2, 24, 0, 0)'}),
