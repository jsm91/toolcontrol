...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Login'
        db.create_table(u'tools_login', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('employee', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['tools.Employee'])),
            ('timestamp', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal(u'tools', ['Login'])


        # Changing field 'Employee.customer'
        db.alter_column(u'tools_employee', 'customer_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['customers.Customer'], null=True))

        # Changing field 'Container.customer'
        db.alter_column(u'tools_container', 'customer_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['customers.Customer']))

        # Changing field 'ToolCategory.customer'
        db.alter_column(u'tools_toolcategory', 'customer_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['customers.Customer']))

        # Changing field 'ConstructionSite.customer'
        db.alter_column(u'tools_constructionsite', 'customer_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['customers.Customer']))

    def backwards(self, orm):
        # Deleting model 'Login'
        db.delete_table(u'tools_login')


        # Changing field 'Employee.customer'
        db.alter_column(u'tools_employee', 'customer_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['admin.Customer'], null=True))

        # Changing field 'Container.customer'
        db.alter_column(u'tools_container', 'customer_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['admin.Customer']))

        # Changing field 'ToolCategory.customer'
        db.alter_column(u'tools_toolcategory', 'customer_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['admin.Customer']))

        # Changing field 'ConstructionSite.customer'
        db.alter_column(u'tools_constructionsite', 'customer_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['admin.Customer']))
