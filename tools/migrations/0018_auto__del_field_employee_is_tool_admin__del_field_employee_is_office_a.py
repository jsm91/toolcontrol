...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Employee.is_tool_admin'
        db.delete_column(u'tools_employee', 'is_tool_admin')

        # Deleting field 'Employee.is_office_admin'
        db.delete_column(u'tools_employee', 'is_office_admin')

        # Adding field 'Employee.is_admin'
        db.add_column(u'tools_employee', 'is_admin',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Employee.is_tool_admin'
        db.add_column(u'tools_employee', 'is_tool_admin',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Employee.is_office_admin'
        db.add_column(u'tools_employee', 'is_office_admin',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Deleting field 'Employee.is_admin'
        db.delete_column(u'tools_employee', 'is_admin')
