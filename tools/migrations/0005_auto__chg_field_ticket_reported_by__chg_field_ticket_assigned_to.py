...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Ticket.reported_by'
        db.alter_column(u'tools_ticket', 'reported_by_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['customers.Customer'], null=True))

        # Changing field 'Ticket.assigned_to'
        db.alter_column(u'tools_ticket', 'assigned_to_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['tools.Employee']))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Ticket.reported_by'
        raise RuntimeError("Cannot reverse this migration. 'Ticket.reported_by' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'Ticket.assigned_to'
        raise RuntimeError("Cannot reverse this migration. 'Ticket.assigned_to' and its values cannot be restored.")
