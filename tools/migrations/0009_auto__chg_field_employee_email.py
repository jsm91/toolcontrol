...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'tools_employee', 'email', self.gf('django.db.models.fields.EmailField')(max_length=255, null=True))

    def backwards(self, orm):

        # Changing field 'Employee.email'
        db.alter_column(u'tools_employee', 'email', self.gf('django.db.models.fields.EmailField')(default='', max_length=255))
