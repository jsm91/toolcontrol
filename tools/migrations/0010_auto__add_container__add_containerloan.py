...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'tools_container', (
            ...
            ('location', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['tools.ConstructionSite'])),
    ...
    models = {
        ...
        u'tools.container': {
            ...
            'location': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['tools.ConstructionSite']"}),
